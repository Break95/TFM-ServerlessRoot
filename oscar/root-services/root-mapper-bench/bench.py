...
f_bs = open(f'{sys.argv[2]}/benchmarks/mapper_{file_name}_start_{ts}', 'wb')
f_be = open(f'{sys.argv[2]}/benchmarks/mapper_{file_name}_end_{ts}', 'wb')
f_cp = open(f'{sys.argv[2]}/benchmarks/mapper_{file_name}_cpupercent_{ts}', 'wb')
f_ns = open(f'{sys.argv[2]}/benchmarks/mapper_{file_name}_netiost_{ts}', 'wb')
f_ne = open(f'{sys.argv[2]}/benchmarks/mapper_{file_name}_netioend_{ts}', 'wb')
